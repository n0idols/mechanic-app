/*
  ...
  - Added the required column `when` to the `Appointment` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Service" ADD COLUMN     "appointmentId" INTEGER;
